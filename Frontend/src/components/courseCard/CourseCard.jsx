...
export const CourseCard = ({ courseData }) => {
    ...
    return (
        <div className='flex flex-col gap-5 p-6 transition-colors border border-gray-200 shadow-sm cursor-pointer bg-bg-surface rounded-xl hover:border-blue-700 '>
