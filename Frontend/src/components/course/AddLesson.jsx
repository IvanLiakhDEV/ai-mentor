            ...
            <div>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    {activeTabText === 'theory' && errors.theory?.content && (
                        <p className='text-sm text-red-500'>{errors.theory.content.message}</p>
                    )}
                    {activeTabText === 'practice' && errors.practice?.taskDescription && (
                        <p className='text-sm text-red-500'>{errors.practice.taskDescription.message}</p>
                    )}
                </div>
            </div>
